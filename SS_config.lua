...
SS_optionsTable2 = {
	[1] = { parent = "main", pname = "Satchel Scanner", frame = "SS_ScannerMain",
		...
		SS_aboutTextQ2 = { loc = "TOPLEFT", x = 10, y = -124, fontSize = 16, text = "|cFF0080FFQ: Can you really receive an satchel as DPS?|r"},
		...
		SS_aboutTextA4 = { loc = "TOPLEFT", x = 10, y = -220, fontSize = 16, text = "A: No, this will never happen. However I plan on adding a 'Quick-Queue' that requires user input."},
