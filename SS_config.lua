...
SS_optionsTable2 = {
	[1] = { parent = "main", pname = "Satchel Scanner", frame = "SS_ScannerMain",
		...
		SS_aboutTextQ2 = { loc = "TOPLEFT", x = 10, y = -124, fontSize = 16, text = "|cFF0080FFQ: Can you really receive a satchel as DPS?|r"},
		SS_aboutTextA2 = { loc = "TOPLEFT", x = 10, y = -140, fontSize = 16, text = "A: Yes. It may be uncommon, but it does exist."},
		SS_aboutTextQ3 = { loc = "TOPLEFT", x = 10, y = -164, fontSize = 16, text = "|cFF0080FFQ: I'm having an odd issue that only seems to be occurring for me, solution?|r"},
	...
	[2] = { parent = "main", pname = "Options", frame = "SS_ScannerOptions",
		...
		SS_optionsTextSubHeader = { fontSize = 18, loc = "TOP", x = 0, y = -30, text = "|cffff0000Scanner Options|r"},
		...
		SS_optionText9 = { loc = "TOPLEFT", x = 30, y = -190, fontSize = 14, text = "Play Sound Warning"},
		SS_optionText10 = { loc = "TOPLEFT", x = 30, y = -210, fontSize = 14, text = "Show Raid Warning"},
		SS_optionText11 = { loc = "TOPLEFT", x = 250, y = -170, fontSize = 14, text = "Auto Scan"},
		-- SliderText
		...
		-- Boxes
		SS_playSoundButton = { loc = "TOPLEFT", x = 8, y = -185, tooltip = "Plays a Sound if a Satchel is found"},
		SS_raidWarningButton = { loc = "TOPLEFT", x = 8, y = -205, tooltip = "Shows a Raid Warning if a Satchel is found"},
		...
		SS_DisableGearButton = { loc = "TOPLEFT", x = 228, y = -65, tooltip = "Scan for Dungeons/LFR-Wing roles you cannot queue for (Not yet implemented)"},
		SS_DisableClassButton = { loc = "TOPLEFT", x = 228, y = -85, tooltip = "Scan for Dungeons/LFR-Wings you do not have the gear to queue for (Not yet implemented)"},
		...
		SS_autoScanButton = { loc = "TOPLEFT", x = 228, y = -165, tooltip = "Automatically Scan for selected Instances after addon load"},
	};
	[3] = { parent = "main", pname = "Instances", frame = "SS_ScannerInstances",
		...
		SS_InstanceTextSubHeader = { fontSize = 18, loc = "TOP", x = 0, y = -30, text = "|cffff0000Instance Options|r"},
